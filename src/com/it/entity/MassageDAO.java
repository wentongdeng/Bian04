	...
	public List creatExtendMassage(Massage[]list){
		...
		for(int n=0;n<list.length;n++){
			...
			if(user!=null){
				...
				extendMassage.setIcon(user.getPicture());
				extendMassage.setName(user.getName());
				
				for(int t=0;t<msList.size();t++){
					photos1.add(msList.get(t).getAddress());
					photos2.add(msList.get(t).getAddress());
				}
...
//		extendMassage.setTitle(massage.getTitle());
		extendMassage.setTime(massage.getTime());
		extendMassage.setText(massage.getText());
		extendMassage.setLike_count(massage.getLike());
		extendMassage.setComment_count(massage.getComment());
